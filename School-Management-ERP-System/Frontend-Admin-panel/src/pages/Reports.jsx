...
const INITIAL_REPORTS = [
  ...
  {
    id: 2,
    name: "Term 2 Fee Collection Report",
    type: "XLSX",
    size: "148 KB",
    updated: "2026-08-31",
  },
  {
    id: 3,
    name: "Class-wise Examination Analysis",
    type: "PDF",
    size: "540 KB",
    updated: "2026-08-29",
  },
  {
    id: 4,
    name: "Admission Funnel — Aug 2026",
    type: "XLSX",
    size: "88 KB",
    updated: "2026-08-28",
  },
  ...
  {
    id: 6,
    name: "Transport Utilization Report",
    type: "XLSX",
    size: "96 KB",
    updated: "2026-08-22",
  },
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span className="text-[11.5px] text-slate-text/60">
                        {r.size} · Updated {formatDate(r.updated)}
                      </span>
                    </div>
                  </div>
                </div>
